...
# 渲染缩放因子（清晰度优先：1600x1200 = 2x）：根据情况修改
RENDER_SCALE = 2
...
# 僵尸参考尺寸（原始设计基准）
BASE_ZOMBIE_REF_WIDTH = 166
BASE_ZOMBIE_REF_HEIGHT = 144

# 高清僵尸判断阈值（超过 2 倍认为是高清）
HD_ZOMBIE_WIDTH_THRESHOLD = BASE_ZOMBIE_REF_WIDTH * 2   # 332
HD_ZOMBIE_HEIGHT_THRESHOLD = BASE_ZOMBIE_REF_HEIGHT * 2  # 288

# 背景图参考尺寸（原始设计基准）
BASE_BACKGROUND_REF_WIDTH = 1400
BASE_BACKGROUND_REF_HEIGHT = 600

# 高清背景判断阈值（超过 2 倍认为是高清）
HD_BACKGROUND_WIDTH_THRESHOLD = BASE_BACKGROUND_REF_WIDTH * 2   # 2800
HD_BACKGROUND_HEIGHT_THRESHOLD = BASE_BACKGROUND_REF_HEIGHT * 2  # 1200

# 太阳参考尺寸（原始设计基准）
BASE_SUN_REF_WIDTH = 78
BASE_SUN_REF_HEIGHT = 78

# 高清太阳判断阈值（超过 2 倍认为是高清）
HD_SUN_WIDTH_THRESHOLD = BASE_SUN_REF_WIDTH * 2   # 156
HD_SUN_HEIGHT_THRESHOLD = BASE_SUN_REF_HEIGHT * 2  # 156
